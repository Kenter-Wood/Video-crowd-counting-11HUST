...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default="Xuezhang")
    parser.add_argument('--data_path', default="./Xuezhang_WM", type=str)

    # misc parameters
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='./outputs/Xuezhang/Xuezhang_WM/CroHD+WM.pth', help='resume from checkpoint')
