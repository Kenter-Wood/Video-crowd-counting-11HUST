...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default="WuhanMetro")
    parser.add_argument('--data_path', default="./data/WuhanMetro_origin", type=str)

    # misc parameters
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='./outputs/Xuezhang/Xuezhang_WM/best_checkpoint.pth', help='resume from checkpoint')
...
def main(args):
    ...
    pred(model, data_loader_val, device, json_path='./test_json', vis_dir=vis_dir)
